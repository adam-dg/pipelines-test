...
/opt/ci-tools/git-relay/git-relay-push.sh --src-repo-path=/opt/atlassian/bitbucketci/agent/build --git-username="Jenkins Deeson" --git-email="jenkins@deeson.co.uk"
